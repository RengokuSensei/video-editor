            ...
            <div className={styles.app}>
              ...
              <div className={styles.toolsPanel}>
                ...
                <button
                  ...
                  title="Select Box (B)"
                >
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></svg>
                </button>
                <button
                  className={`${styles.toolBtn}`}
                  onClick={() => {
